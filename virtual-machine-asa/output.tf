...
output "public_ip_addresses_outside1" {
  value = azurerm_public_ip.asa_public_ip_outside1
}
output "public_ip_addresses_outside2" {
  value = azurerm_public_ip.asa_public_ip_outside2
}