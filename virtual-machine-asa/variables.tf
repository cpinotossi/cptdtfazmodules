variable "asa_public_ip_inside1_id" {
  description = "The ID of the public IP for the inside1 NIC"
  type        = string
}

variable "private_ip_outside2" {
  description = "The static private IP address for the second outside NIC"
  type        = string
}

variable "private_ip_outside1" {
  description = "The static private IP address for the second outside NIC"
  type        = string
}

variable "private_ip_inside" {
  description = "The static private IP address for the second outside NIC"
  type        = string
}
...
variable "subnet_inside1_id" {
  type = string
}

variable "subnet_outside1_id" {
  type = string
}

variable "subnet_outside2_id" {
  type = string
}
